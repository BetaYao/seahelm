 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font ../managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 96 --bpp 4 --format lvgl --range 0x30-0x39 --no-compress -o sh_font_num_96.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef SH_FONT_NUM_96
#define SH_FONT_NUM_96 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t sh_font_num_96 = {
#else
lv_font_t sh_font_num_96 = {
#endif
