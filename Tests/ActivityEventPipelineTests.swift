...
final class ActivityEventPipelineTests: XCTestCase {
    ...
    func testExtractorProducesValidEvents() {
        let data: [String: Any] = [
            "tool_name": "Read",
            "tool_input": ["file_path": "/Users/dev/project/Sources/Core/AgentRegistry.swift"],
        ]
        ...
        XCTAssertEqual(activity.detail, "Core/AgentRegistry.swift")
    ...
    func testRingBufferMaintainsOrder() {
        ...
        for tool in tools {
            ...
            AgentRegistry.appendToRingBuffer(&buffer, event: event, maxSize: 20)
        }
