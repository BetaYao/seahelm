...
final class SplitNodeTests: XCTestCase {
    ...
    func testSingleLeaf() {
        let node = SplitNode.leaf(id: "a", stationId: "s1", sessionName: "seahelm-repo-main")
    ...
    func testSplitNodeLeafCount() {
        let left = SplitNode.leaf(id: "a", stationId: "s1", sessionName: "seahelm-repo-main")
        let right = SplitNode.leaf(id: "b", stationId: "s2", sessionName: "seahelm-repo-main-1")
...
final class SplitTreeTests: XCTestCase {
    ...
    func testInitialState() {
        let tree = SplitTree(worktreePath: "/repo/main", rootLeafId: "a", stationId: "s1", sessionName: "seahelm-repo-main")
